...
public class GrafiskInterface extends JFrame {
    ...
    private JPanel createStartPanel() {
        ...
        startButton.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 20));
    ...
    public void createCategory(List<String> categories) {
        ...
        label.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 18));
        ...
        button1.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
        button1.setBackground(golden);
        JButton button2 = new JButton(categoryList.get(1));
        button2.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
        button2.setBackground(golden);
        JButton button3 = new JButton(categoryList.get(2));
        button3.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
    ...
    public JPanel createQuizPanel(Question question) {
        ...
        titleLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 18));
        ...
        questionTextArea.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 20));
        ...
        answerButton1.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
        ...
        answerButton2.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
        ...
        answerButton3.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
        ...
        answerButton4.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
    ...
    public void scorePanelBetweenRounds(QuizScore yourScoreBoard) {
        ...
        player1Label.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 10));
        ...
        roundLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 10));
        ...
        player2Label.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 10));
...
//                    label.setBorder(BorderGUI.THIN_BORDER);
            ...
            roundNrPanel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 58));
...
//                    label.setBorder(BorderGUI.THIN_BORDER);
    ...
    public void finalScorePanel(QuizScore finalScoreBoard) {
        ...
        JLabel finalScoreLabel = new JLabel("RESULT", SwingConstants.CENTER);
        finalScoreLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 24));
        ...
        scoresLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 20));
        ...
        resultLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 20));
...
//            rowPanel.setBorder(BorderGUI.SIMPLE_BORDER);
            ...
            roundNrLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 14));
        ...
        exitButton.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 16));
    ...
    private JLabel createScoreLabel(int score) {
        ...
        label.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 12));
        label.setBorder(BorderGUI.THIN_BORDER);
        label.setOpaque(true);
    ...
    public void displayWaitingForPlayers() {
        ...
        waitingForPlayersLabel.setFont(FontsGUI.MarioKart.deriveFont(Font.BOLD, 20));
